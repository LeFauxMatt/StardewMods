...
namespace ExpandedStorage.Framework.Models
{
    ...
    internal class StorageConfig
    {
        ...
        internal StorageConfig()
            : this(null, Chest.capacity, true, new List<string>(), new List<string>(), new List<string>()) { }
        internal StorageConfig(StorageConfig config)
            : this(config.StorageName, config.Capacity, config.CanCarry, config.AllowList, config.BlockList, config.Tabs) { }
        internal StorageConfig(string storageName, int capacity, bool canCarry, IList<string> allowList, IList<string> blockList, IList<string> tabs)
        {
