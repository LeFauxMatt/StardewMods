...
/// <summary>Represents <see cref="IStorageData" /> with parent-child relationship.</summary>
internal sealed class StorageNode : IStorageData, IComparable<StorageNode>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="StorageNode" /> class.</summary>
    ...
    /// <summary>Gets the <see cref="IStorageData" />.</summary>
    public IStorageData Data { get; }

    /// <summary>Gets an ItemMatcher to represent the currently selected filters.</summary>
    ...
    /// <summary>Gets or sets the parent <see cref="IStorageData" />.</summary>
    ...
    {
        get =>
            this.Data.CarryChestSlow switch
            {
                _ when this.Parent.CarryChestSlow is FeatureOption.Disabled => FeatureOption.Disabled,
                FeatureOption.Default when this.Parent.CarryChestSlow is FeatureOption.Default =>
    ...
    {
        get =>
            this.Data.ChestMenuTabs switch
            {
    ...
    {
        get =>
            this.Data.ConfigureMenu switch
            {
    ...
    {
        get =>
            this.Data.CraftFromChest switch
            {
    ...
    {
        get =>
            this.Data.CraftFromChestDisableLocations.Any()
    ...
    {
        get =>
            this.Data.CraftFromChestDistance != 0
    ...
    {
        get =>
            this.Data.CustomColorPicker switch
            {
                _ when this.Parent.CustomColorPicker is FeatureOption.Disabled => FeatureOption.Disabled,
                FeatureOption.Default when this.Parent.CustomColorPicker is FeatureOption.Default => FeatureOption
                    .Disabled,
    ...
    {
        get =>
            this.Data.OpenHeldChest switch
            {
    ...
    {
        get =>
            this.Data.OrganizeChest switch
            {
    ...
    {
        get =>
            this.Data.OrganizeChestGroupBy switch
            {
    ...
    {
        get =>
            this.Data.OrganizeChestSortBy switch
            {
    ...
    {
        get =>
            this.Data.StashToChest switch
            {
                _ when this.Parent.StashToChest is FeatureOptionRange.Disabled => FeatureOptionRange.Disabled,
                FeatureOptionRange.Default when this.Parent.StashToChest is FeatureOptionRange.Default =>
                    FeatureOptionRange.Disabled,
    ...
    {
        get =>
            this.Data.StashToChestDisableLocations.Any()
    ...
    {
        get =>
            this.Data.StashToChestStacks switch
            {
                _ when this.Parent.StashToChestStacks is FeatureOption.Disabled => FeatureOption.Disabled,
                FeatureOption.Default when this.Parent.StashToChestStacks is FeatureOption.Default => FeatureOption
                    .Disabled,
    ...
    {
        get =>
            this.Data.TransferItems switch
            {
    ...
    {
        get =>
            this.Data.UnloadChestCombine switch
            {
                _ when this.Parent.UnloadChestCombine is FeatureOption.Disabled => FeatureOption.Disabled,
                FeatureOption.Default when this.Parent.UnloadChestCombine is FeatureOption.Default => FeatureOption
                    .Disabled,
