...
internal sealed class ConfigMenu
{
    ...
    public void SetupMainConfig()
    {
        ...
        if (this.config.ConfigureMenu is InGameMenu.Advanced)
        {
        ...
        this.gmcm.Api.AddKeybindList(
            this.manifest,
            () => this.config.ControlScheme.CloseChestFinder,
            value => this.config.ControlScheme.CloseChestFinder = value,
            I18n.Config_CloseChestFinder_Name,
            I18n.Config_CloseChestFinder_Tooltip);

        this.gmcm.Api.AddKeybindList(
            this.manifest,
            () => this.config.ControlScheme.OpenFoundChest,
            value => this.config.ControlScheme.OpenFoundChest = value,
            I18n.Config_OpenFoundChest_Name,
            I18n.Config_OpenFoundChest_Tooltip);

        this.gmcm.Api.AddKeybindList(
            this.manifest,
            () => this.config.ControlScheme.OpenNextChest,
            value => this.config.ControlScheme.OpenNextChest = value,
        ...
        this.gmcm.Api.AddKeybindList(
            this.manifest,
            () => this.config.ControlScheme.ScrollPage,
            value => this.config.ControlScheme.ScrollPage = value,
        ...
        this.gmcm.Api.AddKeybindList(
            this.manifest,
            () => this.config.ControlScheme.ToggleInfo,
            value => this.config.ControlScheme.ToggleInfo = value,
    ...
    private void ResetConfig()
    {
        ...
        // Copy controls
        this.config.ControlScheme.CloseChestFinder = defaultConfig.ControlScheme.CloseChestFinder;
        this.config.ControlScheme.Configure = defaultConfig.ControlScheme.Configure;
        this.config.ControlScheme.FindChest = defaultConfig.ControlScheme.FindChest;
        this.config.ControlScheme.LockSlot = defaultConfig.ControlScheme.LockSlot;
        this.config.ControlScheme.NextTab = defaultConfig.ControlScheme.NextTab;
        this.config.ControlScheme.OpenCrafting = defaultConfig.ControlScheme.OpenCrafting;
        this.config.ControlScheme.OpenFoundChest = defaultConfig.ControlScheme.OpenFoundChest;
        this.config.ControlScheme.OpenNextChest = defaultConfig.ControlScheme.OpenNextChest;
        this.config.ControlScheme.PreviousTab = defaultConfig.ControlScheme.PreviousTab;
        this.config.ControlScheme.ScrollDown = defaultConfig.ControlScheme.ScrollDown;
        this.config.ControlScheme.ScrollPage = defaultConfig.ControlScheme.ScrollPage;
        this.config.ControlScheme.ScrollUp = defaultConfig.ControlScheme.ScrollUp;
        this.config.ControlScheme.StashItems = defaultConfig.ControlScheme.StashItems;
        this.config.ControlScheme.ToggleInfo = defaultConfig.ControlScheme.ToggleInfo;
    ...
    private void SetupStorageConfig(IManifest modManifest, IStorageData storage, bool inGame = false)
    {
        ...
        this.SetupFeatureConfig(nameof(ChestMenuTabs), modManifest, storage, inGame);
        this.SetupFeatureConfig(nameof(CollectItems), modManifest, storage, inGame);
        this.SetupFeatureConfig(nameof(Configurator), modManifest, storage, inGame);
        this.SetupFeatureConfig(nameof(CraftFromChest), modManifest, storage, inGame);
        this.SetupFeatureConfig(nameof(BetterColorPicker), modManifest, storage, inGame);
