...
internal class AssetHandler : BaseService, IAssetLoader
{
    ...
    internal AssetHandler(ServiceLocator serviceLocator)
        : base("AssetHandler")
    {
        // Init
        this._content = serviceLocator.Helper.Content;
        serviceLocator.Helper.Content.AssetLoaders.Add(this);

        // Events
        serviceLocator.Helper.Events.GameLoop.DayEnding += this.OnDayEnding;
    }
