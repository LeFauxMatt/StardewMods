...
/// <summary>Event arguments for a StorageTypeRequested event.</summary>
public interface IStorageTypeRequestedEventArgs
{
    /// <summary>Gets the context object of the storage.</summary>
    public object Context { get; }

    /// <summary>Loads storage data for this chest type.</summary>
