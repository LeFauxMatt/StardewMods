...
public interface IGenericModConfigMenuApi
{
    ...
    ****/
    ...
    /// </param>
    /// <remarks>
    ///     The custom logic represented by <paramref name="draw" /> and <paramref name="saveChanges" /> is responsible
    ///     for managing its own state if needed. For example, you can store state in a static field or use closures to use a
    ///     state variable.
    /// </remarks>
