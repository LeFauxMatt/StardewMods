...
internal sealed class WateringCanManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="WateringCanManager" /> class.</summary>
