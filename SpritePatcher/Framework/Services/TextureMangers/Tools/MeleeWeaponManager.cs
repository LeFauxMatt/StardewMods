...
internal sealed class MeleeWeaponManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="MeleeWeaponManager" /> class.</summary>
