...
internal sealed class FishPondManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="FishPondManager" /> class.</summary>
