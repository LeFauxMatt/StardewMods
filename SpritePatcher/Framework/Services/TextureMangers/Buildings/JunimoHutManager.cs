...
internal sealed class JunimoHutManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="JunimoHutManager" /> class.</summary>
