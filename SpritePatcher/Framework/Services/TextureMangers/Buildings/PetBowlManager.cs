...
internal sealed class PetBowlManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="PetBowlManager" /> class.</summary>
