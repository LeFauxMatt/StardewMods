...
internal sealed class BuildingManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="BuildingManager" /> class.</summary>
    ...
    public BuildingManager(
        ...
        this.Patches.Add(
            ...
            new SavedPatch(
                ...
                AccessTools.DeclaredMethod(typeof(BaseTextureManager), nameof(BaseTextureManager.DrawBackground)),
                PatchType.Transpiler),
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Building), nameof(Building.drawInConstruction)),
                AccessTools.DeclaredMethod(typeof(BaseTextureManager), nameof(BaseTextureManager.DrawInConstruction)),
                PatchType.Transpiler),
            new SavedPatch(
            ...
            new SavedPatch(
                ...
                AccessTools.DeclaredMethod(typeof(BaseTextureManager), nameof(BaseTextureManager.DrawShadow)),
                PatchType.Transpiler));
