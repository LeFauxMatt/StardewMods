...
internal sealed class WoodChipperManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="WoodChipperManager" /> class.</summary>
