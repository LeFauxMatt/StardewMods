...
internal sealed class FurnitureManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="FurnitureManager" /> class.</summary>
    ...
    public FurnitureManager(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Furniture), nameof(Furniture.draw)),
