...
internal sealed class FishTankFurnitureManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="FishTankFurnitureManager" /> class.</summary>
    ...
    public FishTankFurnitureManager(
