...
internal sealed class ItemPedestalManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="ItemPedestalManager" /> class.</summary>
