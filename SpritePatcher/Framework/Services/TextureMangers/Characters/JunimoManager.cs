...
internal sealed class JunimoManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="JunimoManager" /> class.</summary>
