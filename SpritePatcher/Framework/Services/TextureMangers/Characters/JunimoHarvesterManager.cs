...
internal sealed class JunimoHarvesterManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="JunimoHarvesterManager" /> class.</summary>
