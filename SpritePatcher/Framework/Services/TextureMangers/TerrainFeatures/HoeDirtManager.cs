...
internal sealed class HoeDirtManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="HoeDirtManager" /> class.</summary>
