...
internal sealed class ResourceClumpManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="ResourceClumpManager" /> class.</summary>
