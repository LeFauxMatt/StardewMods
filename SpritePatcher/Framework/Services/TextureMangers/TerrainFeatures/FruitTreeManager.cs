...
internal sealed class FruitTreeManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="FruitTreeManager" /> class.</summary>
    ...
    public FruitTreeManager(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(FruitTree), nameof(FruitTree.draw)),
