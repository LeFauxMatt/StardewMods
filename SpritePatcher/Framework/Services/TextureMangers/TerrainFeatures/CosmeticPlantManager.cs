...
internal sealed class CosmeticPlantManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="CosmeticPlantManager" /> class.</summary>
