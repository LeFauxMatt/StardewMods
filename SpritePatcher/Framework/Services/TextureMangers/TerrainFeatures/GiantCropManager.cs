...
internal sealed class GiantCropManager : BaseTextureManager
{
    /// <summary>Initializes a new instance of the <see cref="GiantCropManager" /> class.</summary>
