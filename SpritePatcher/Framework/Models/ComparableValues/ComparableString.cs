...
/// <inheritdoc />
internal sealed class ComparableString(Func<string> getter) : IEquatable<string>
{
    ...
    /// <inheritdoc />
    public bool Equals(string? expression) => ComparableString.Equals(getter(), expression);

    /// <inheritdoc />
    public override string ToString() => getter();
